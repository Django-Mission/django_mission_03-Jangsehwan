    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', '문의 등록'), ('1', '접수 완료'), ('1', '답변 완료')], default='1', max_length=2, verbose_name='상태')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='', max_length=80, verbose_name='질문 제목')),
